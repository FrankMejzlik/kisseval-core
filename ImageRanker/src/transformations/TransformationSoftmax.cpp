...
TransformationSoftmax::TransformationSoftmax(const KeywordsContainer& keywords, Matrix<float>& data_mat,
    ...
    : BaseVectorTransform(accumulate_hypernyms(keywords, apply_real(data_mat), HyperAccumType::SUM),
                          accumulate_hypernyms(keywords, apply_real(data_mat), HyperAccumType::MAX),
...
TransformationSoftmaxGoogleVision::TransformationSoftmaxGoogleVision(const KeywordsContainer& keywords, Matrix<float>& data_mat,
                                             [[maybe_unused]] const std::string& options)
    : BaseVectorTransform(BaseVectorTransform(calc_stats(keywords, apply(data_mat), false), std::pair<Matrix<float>, DataInfo>()))
{
}