 ...
 */
class TransformationNoTransform : public TransformationFunctionBase
{
 public:
  struct Settings
  {
  ...
  // Methods
 public:
  TransformationNoTransform() : TransformationFunctionBase(InputDataTransformId::cNoTransform) {}
